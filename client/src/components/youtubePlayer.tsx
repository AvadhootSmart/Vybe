...
import { LucidePause, LucidePlay, LucideSkipBack, LucideSkipForward, LucideVolume2, LucideVolumeX } from "lucide-react";
...
const YoutubePlayer = ({ track, onPrev, onNext }: YoutubePlayerProps) => {
    ...
    return (
        <div className="p-2 bg-white/10 backdrop-blur-lg w-full flex sm:flex-row flex-col font-Poppins rounded-xl sm:justify-between sm:items-center items-center relative">
            ...
            <div className="hidden gap-2 sm:flex">
                <img src="/apple-touch-icon.png" alt="album-img" className="size-20 rounded-lg" />
